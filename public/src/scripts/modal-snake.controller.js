(function (angular) {
    'use strict';
    angular.module('issueTrackerApp').controller('SnakeCtrl', SnakeCtrl);
    SnakeCtrl.$inject = ['$scope', '$http', '$uibModalInstance', '$window', '$timeout', 'snake', 'login'];

    function SnakeCtrl($scope, $http, $uibModalInstance, $window, $timeout, snake, login) {
        var vm = this;
        vm.snakeRes = snake;
        vm.name = login;
